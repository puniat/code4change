            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center mb-12">
                <div className="inline-block relative">
                  <span className="text-sm font-bold tracking-wider text-primary uppercase mb-3 block">Our Mission</span>
            ...
            <div className="bg-card rounded-xl p-8 shadow-sm border border-muted relative overflow-hidden">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <span className="font-medium">Middle school students (grades 4-8)</span>
